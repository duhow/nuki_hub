...
void Network::publishHASSConfig(char* deviceType, const char* baseTopic, _nukiConfig, const char* availabilityTopic, const bool& hasKeypad, char* lockAction, char* unlockAction, char* openAction)
{
    JsonDocument json;
    json.clear();
