...
public:
    ...
    void publishHASSConfig(char* deviceType, const char* baseTopic, Config _nukiConfig, const char* availabilityTopic, const bool& hasKeypad, char* lockAction, char* unlockAction, char* openAction);
